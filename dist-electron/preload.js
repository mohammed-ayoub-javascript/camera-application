...
electron.contextBridge.exposeInMainWorld("serialAPI", {
  openSerialPort: (portName) => electron.ipcRenderer.invoke("open-serial-port", portName),
  sendToArduino: (message) => electron.ipcRenderer.invoke("send-to-arduino", message)
});
